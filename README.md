...
I removed `sqlmap` because of the reasons above but `Metasploit` is still part of the guide because you can use it for one specific module. Thank you `Debajyoti Maity` for making me aware and to [yeep](https://github.com/Yeeb1) for the resources.
